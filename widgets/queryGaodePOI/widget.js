    ...
    _createClass(MyWidget, [{
      ...
      value: function showPOIPage(data, counts) {
        ...
        if (counts == 0) {
          ...
          var _fyhtml;
          if (this.allpage > 1) {
            _fyhtml = '<div class="querybar-ye querybar-fr">' + this.thispage + "/" + this.allpage + '页  <a href="javascript:queryGaodePOIWidget.showFirstPage()">首页</a> <a href="javascript:queryGaodePOIWidget.showPretPage()">&lt;</a>  <a href="javascript:queryGaodePOIWidget.showNextPage()">&gt;</a> </div>';
          } else {
            _fyhtml = "";
          }
