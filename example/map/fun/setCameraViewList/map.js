...
function showCameraRoute(viewPoints) {
  ...
  for (var i = 0; i < viewPoints.length; i++) {
    ...
    // 文本
    var graphic = new mars3d.graphic.LabelPrimitive({
      position: position,
      style: {
        text: i,
        font_size: 14
    ...
    var frustumPrimitive = new mars3d.graphic.FrustumPrimitive({
      position: position,
      camera: camera,
      style: {
        angle: 45,
  ...
  // 线
  var graphicLine = new mars3d.graphic.PolylinePrimitive({
    positions: points,
    style: {
      width: 1,
