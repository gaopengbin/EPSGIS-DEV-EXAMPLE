...
var styleConfig = {
  ...
  label: {
    ...
    style: [{
      ...
      type: "color",
      defval: "#ffffff",
      show: function show(style, allStyle, graphicType) {
  ...
  circle: {
    ...
    style: [{
      ...
      show: function show(style, allStyle, graphicType) {
        return style.fill !== false && this.data.some(function (item) {
          return item.value === style.materialType;
        });
      }
    }, {
  ...
  polyline: {
    ...
    style: [{
      ...
      data: [{
        ...
        value: "LineFlow-4",
        defval: {
          image: "img/textures/line-color-aqua.png",
          repeat_x: 10
        }
      }, {
        label: "流动azure",
        ...
        value: "LineFlow-6",
        defval: {
          image: "img/textures/line-color-red.png",
          color: "#ff0000",
          repeat_x: 10
        }
      }, {
        ...
        value: "LineFlow-14",
        defval: {
          image: "img/textures/line-vertebral.png",
          repeat_x: 10
        }
      }, {
        ...
        value: "LineFlow-15",
        defval: {
          image: "img/textures/line-vertebral-blue.png",
          repeat_x: 10
        }
      }, {
        label: "流动fence-line",
        ...
        value: "LineFlow-17",
        defval: {
          image: "img/textures/line-arrow-trans.png",
          repeat_x: 10
        }
      }],
      show: function show(style, allStyle, graphicType) {
  ...
  polygon: {
    name: "面",
    primitive: true,
    "extends": ["video2D", "attackArrow", "attackArrowPW", "attackArrowYW", "closeVurve", "straightArrow", "doubleArrow", "fineArrow", "fineArrowYW", "areaMeasure", "gatheringPlace", "isosTriangle", "lune", "regular"],
    style: [{
      name: "diffHeight",
      label: "立体高度",
      type: "number",
  ...
  water: {
    ...
    style: [{
      ...
      label: "反射图片",
      type: "label",
      defval: "img/textures/waterNormals.jpg"
    }, {
      name: "frequency",
      label: "波数",
      type: "number",
...
var _loop = function _loop(key) {
  ...
  if (styleConfig[key]["extends"]) {
    styleConfig[key]["extends"].forEach(function (element) {
